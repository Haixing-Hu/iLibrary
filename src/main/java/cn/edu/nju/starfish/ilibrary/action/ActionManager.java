...
public final class ActionManager {
  ...
  public ActionManager(Application application) {
    ...
    this.add(new FlagFilterAction(application));
    this.add(new FlagFilterAllAction(application));
    this.add(new FlagFilterFlaggedAction(application));
    this.add(new FlagFilterUnflaggedAction(application));
    this.add(new ReadFilterAction(application));
    this.add(new ReadFilterAllAction(application));
    this.add(new ReadFilterUnreadAction(application));
    this.add(new ReadFilterReadingAction(application));
    this.add(new ReadFilterHasReadAction(application));
    this.add(new TypeFilterAction(application));
    this.add(new TypeFilterAllAction(application));
    this.add(new TypeFilterArticleAction(application));
    this.add(new TypeFilterBookAction(application));
    this.add(new TypeFilterReportAction(application));
    this.add(new TypeFilterPatentAction(application));
    this.add(new TypeFilterMediaAction(application));
    this.add(new AttachmentFilterAction(application));
    this.add(new AttachmentFilterAllAction(application));
    this.add(new AttachmentFilterHasFileAction(application));
    this.add(new AttachmentFilterNoFileAction(application));
    ...
    this.add(new ArchiveAction(application));
    this.add(new MoveToTrashAction(application));
    this.add(new RestoreFromTrashAction(application));
    this.add(new EmptyTrashAction(application));
    this.add(new EditKeywordsAction(application));
    this.add(new EditNotesAction(application));
    ...
    //  share actions
    this.add(new ShareAction(application));
