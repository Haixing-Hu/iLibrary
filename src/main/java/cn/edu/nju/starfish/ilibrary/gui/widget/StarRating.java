...
public class StarRating extends Canvas {
  ...
  static class Star {
    ...
    static Star initBig(final StarRating parent) {
      ...
      star.parent = parent;
      star.defaultImage = new Image(display, classLoader.getResourceAsStream("/images/stars/32.png"));
      star.hoverImage = new Image(display, classLoader.getResourceAsStream("/images/stars/focus32.png"));
      star.selectedImage = new Image(display, classLoader.getResourceAsStream("/images/stars/mark32.png"));
      star.selectedHoverImage = new Image(display, classLoader.getResourceAsStream("/images/stars/mark-focus32.png"));
      return star;
    }
    ...
    static Star initSmall(final StarRating parent) {
      ...
      ClassLoader classLoader = star.getClass().getClassLoader();
      star.parent = parent;
      star.defaultImage = new Image(display, classLoader.getResourceAsStream("/images/stars/16.png"));
      star.hoverImage = new Image(display, classLoader.getResourceAsStream("/images/stars/focus16.png"));
      star.selectedImage = new Image(display, classLoader.getResourceAsStream("/images/stars/mark16.png"));
      star.selectedHoverImage = new Image(display, classLoader.getResourceAsStream("/images/stars/mark-focus16.png"));
      return star;
    }
  }
  ...
  private Point computeSizeVertical() {
    ...
    return new Point(width + getBorderWidth() * 2, height + getBorderWidth()
        * 2);
  }
