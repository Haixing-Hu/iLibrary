...
/**
 * The interface of the service for managing {@link Periodical} objects.
 *
 * @author Haixing Hu
 */
public interface PeriodicalService {
  ...
  /**
   * Merges a list of old periodicals to a new periodical.
   *
   * @param oldPeriodicals
   *          The list of old periodicals to be merged.
   * @param newPeriodical
   *          The new periodical after merging. After calling this function, the
   ...
   *           If any error occurs.
   */
  public int merge(List<Periodical> oldPeriodicals, Periodical newPeriodical)
      throws DataAccessException;
