...
public final class FieldTemplateServiceImpl implements FieldTemplateService {
  ...
  public FieldTemplateServiceImpl(final String resourcePattern) {
    ...
    try {
      final JAXBContext context = JAXBContext.newInstance(FieldTemplate.class);
      ...
      logger.error("Failed to load the fild templates from: {}",
          resourcePattern, e);
  ...
  @Override
  public FieldTemplate get(final String name) throws DataAccessException {
