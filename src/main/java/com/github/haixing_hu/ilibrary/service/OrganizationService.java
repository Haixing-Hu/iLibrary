...
public interface OrganizationService {
  ...
  /**
   * Merges a list of old organizations to a new organization.
   *
   * @param oldOrganizations
   *          The list of old organizations to be merged.
   * @param newOrganization
   *          The new organization after merging. After calling this function, the
   ...
   *           If any error occurs.
   */
  public int merge(List<Organization> oldOrganizations, Organization newOrganization)
      throws DataAccessException;
