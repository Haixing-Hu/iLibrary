...
public class AboutDialog extends Dialog {
  ...
  protected Control createDialogArea(Composite parent) {
    ...
    final Composite iconArea = new Composite(container, SWT.NONE);
    final GridData gd_iconArea = new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1);
    gd_iconArea.minimumWidth = 60;
    gd_iconArea.minimumHeight = 80;
    iconArea.setLayoutData(gd_iconArea);
    final FillLayout fl_iconArea = new FillLayout(SWT.HORIZONTAL);
    fl_iconArea.marginWidth = 10;
    fl_iconArea.marginHeight = 10;
    iconArea.setLayout(fl_iconArea);

    final Label lblNewLabel_1 = new Label(iconArea, SWT.NONE);
    lblNewLabel_1.setText("ICON");

    final Composite textArea = new Composite(container, SWT.NONE);
    textArea.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
    textArea.setLayout(new GridLayout(1, false));

    final CLabel productName = new CLabel(textArea, SWT.NONE);
    ...
    final Label lblHaixingHu = new Label(composite, SWT.NONE);
    final FormData fd_lblHaixingHu = new FormData();
    ...
    final CLabel lblcHaixingHu = new CLabel(composite, SWT.NONE);
    ...
    final FormData fd_lblcHaixingHu = new FormData();
