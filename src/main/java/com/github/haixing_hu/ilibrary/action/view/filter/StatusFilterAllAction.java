 ...
 * @author Haixing Hu
 */
public class StatusFilterAllAction extends BaseAction {

  public static final String ID = StatusFilterAction.ID + ".all";

  public StatusFilterAllAction(Application application) {
