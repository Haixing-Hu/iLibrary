...
public class BackwardAction extends BaseAction {
  ...
  public static final String ID = ViewAction.ID + ".backward";

  public static final String BUTTON_CLASS = "button-backward";

  public BackwardAction(Application application) {
