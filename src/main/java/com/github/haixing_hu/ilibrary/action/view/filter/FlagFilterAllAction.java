 ...
 * @author Haixing Hu
 */
public class FlagFilterAllAction extends BaseAction {

  public static final String ID = FlagFilterAction.ID + ".all";
  ...
  public void handle(ActionEvent event) {
    application.getExplorerController().clearFlagStatusFilters();
  }
}
