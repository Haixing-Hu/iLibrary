 ...
 * @author Haixing Hu
 */
public class FlagFilterFlaggedAction extends BaseAction {

  public static final String ID = FlagFilterAction.ID + ".flagged";
  ...
  public void handle(ActionEvent event) {
    application.getExplorerController().setFlagStatusFilter(FlagStatus.FLAGGED);
  }
}
