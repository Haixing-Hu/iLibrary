 ...
 * @author Haixing Hu
 */
public class StatusFilterUnreadAction extends BaseAction {

  public static final String ID = StatusFilterAction.ID + ".unread";

  public StatusFilterUnreadAction(Application application) {
