...
import com.github.haixing_hu.ilibrary.action.edit.annotation.AnnotateAction;
...
public class EditAction extends BaseActionGroup {
  ...
  public EditAction(Application application) {
    ...
    addSubAction(am, new SeparatorAction());
    addSubAction(am, new AnnotateAction(application));
    addSubAction(am, new SeparatorAction());
