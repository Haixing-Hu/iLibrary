...
public class FilterReadStatusToReadAction extends BaseCheckBoxAction {
  ...
  public static final String KEY = FilterReadStatusAction.KEY + ".to-read";

  public FilterReadStatusToReadAction(Application application, IActionManager actionManager) {
    super(KEY, application, actionManager);
  }

  @Override
  public void run() {
    application.setReadStatusFilter(ReadStatusFilter.TO_READ);
  }
}
