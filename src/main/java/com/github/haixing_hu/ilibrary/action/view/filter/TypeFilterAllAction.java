 ...
 * @author Haixing Hu
 */
public class TypeFilterAllAction extends BaseAction {

  public static final String ID = TypeFilterAction.ID + ".all";
  ...
  public void handle(ActionEvent event) {
    application.getExplorerController().clearDocumentTypeFilters();
  }
}
