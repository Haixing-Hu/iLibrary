...
public class FilterTypeArticleAction extends BaseCheckBoxAction {
  ...
  public FilterTypeArticleAction(Application application,
  ...
  public void run() {
    if (isChecked()) {
      application.addTypeStatusFilter(DocumentType.ARTICLE);
    } else {
      application.removeTypeStatusFilter(DocumentType.ARTICLE);
    }
  }
}
