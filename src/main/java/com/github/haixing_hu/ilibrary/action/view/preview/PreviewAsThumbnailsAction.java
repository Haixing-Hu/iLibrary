 ...
 * @author Haixing Hu
 */
public class PreviewAsThumbnailsAction extends BaseAction {

  public static final String ID = PreviewAction.ID + ".as-thumbnails";

  public static final String BUTTON_CLASS = "button-preview-as-thumbnails";

  public PreviewAsThumbnailsAction(Application application) {
