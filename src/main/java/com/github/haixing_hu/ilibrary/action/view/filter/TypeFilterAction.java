 ...
 * @author Haixing Hu
 */
public class TypeFilterAction extends BaseActionGroup {

  public static final String ID = FilterAction.ID + ".type";

  public TypeFilterAction(Application application) {
    super(ID, application);
    final ActionManager am = application.getActionManager();
    addSubAction(am, new TypeFilterAllAction(application));
    for (final DocumentType type : DocumentType.values()) {
      final IAction action = new TypeFilterOfAction(type, application);
