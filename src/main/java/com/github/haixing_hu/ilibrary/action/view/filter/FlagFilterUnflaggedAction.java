 ...
 * @author Haixing Hu
 */
public class FlagFilterUnflaggedAction extends BaseAction {

  public static final String ID = FlagFilterAction.ID + ".unflagged";
  ...
  public void handle(ActionEvent event) {
    application.getExplorerController().setFlagStatusFilter(FlagStatus.UNFLAGGED);
  }
}
