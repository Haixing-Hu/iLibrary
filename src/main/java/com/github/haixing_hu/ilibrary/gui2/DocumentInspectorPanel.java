...
/**
 * The inspector panel for document.
 *
 * @author Haixing Hu
 */
public class DocumentInspectorPanel extends InspectorPanel {

  public DocumentInspectorPanel(Application2 application) {
    super(application);
  }
  ...
  protected void addHeaderButtons(Application2 application, HBox header) {
    ...
    final ToggleButton notesButton = new ToggleButton();
    notesButton.setId(NOTES_BUTTON_ID);
    header.getChildren().add(notesButton);
