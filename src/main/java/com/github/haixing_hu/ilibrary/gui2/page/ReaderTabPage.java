 ...
 * @author Haixing Hu
 */
public class ReaderTabPage extends SplitPane {

  public static final String ID = "reader-tab-page";

  public ReaderTabPage(final Application2 application) {
    final Logger logger = LoggerFactory.getLogger(ReaderTabPage.class);
    logger.trace("Creating {}", ReaderTabPage.class);
    setId(ID);
    ...
    getItems().addAll(workArea, inspector);
