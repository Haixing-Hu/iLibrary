 ...
 * @author Haixing Hu
 */
public class TagsTabPage extends SplitPane {

  public static final String ID = "tags-tab-page";

  public TagsTabPage(final Application2 application) {
    final Logger logger = LoggerFactory.getLogger(TagsTabPage.class);
    logger.trace("Creating {}", TagsTabPage.class);
    setId(ID);
    final NavigatorPanel navigator = new NavigatorPanel(application, Page.TAGS,
        new TreeView<String>());
