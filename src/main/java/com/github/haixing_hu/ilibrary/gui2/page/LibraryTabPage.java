...
/**
 * The tab page for the library module.
 *
 * @author Haixing Hu
 */
public class LibraryTabPage extends SplitPane {

  public static final String ID = "library-tab-page";

  public LibraryTabPage(final Application2 application) {
    final Logger logger = LoggerFactory.getLogger(LibraryTabPage.class);
    logger.trace("Creating {}", LibraryTabPage.class);
    setId(ID);
    final NavigatorPanel navigator = new NavigatorPanel(application,
        Page.LIBRARY, new TreeView<String>());
