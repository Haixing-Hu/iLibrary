 ...
 * See the License for the specific person governing permissions and
...
/**
 * The interface for the DAO of {@link Person}.
 *
 * @author Haixing Hu
 */
public interface PersonDao {
   ...
   *
   * @param person
   *          The new person to add. After calling this function, the ID of
