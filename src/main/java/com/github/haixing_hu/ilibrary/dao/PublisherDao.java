...
/**
 * The interface for the DAO of {@link Publisher}.
 *
 * @author Haixing Hu
 */
public interface PublisherDao {
  ...
  /**
   * Gets the publisher by its name.
   *
   * @param name
   *          The name of a publisher.
   * @return The publisher with the specified name.
   * @throws DataAccessException
   *           If any error occurs.
   */
  public Publisher getByName(String name) throws DataAccessException;
